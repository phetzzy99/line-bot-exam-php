<?php
    $accessToken = 'wgWq9CMNJ5AsWmPgQMVSRaw7hK4yIwkiLWVDr/S+RH+MhUzS5Ygcye71iWRKGYNJdj08hq+1Bn9ckXzfDACsphDPJmdLSiONSmHa/VUDzoaytsA54IppqRhK0DgJJlrmqKKBAf4AiXlwOUEjQ947HQdB04t89/1O/w1cDnyilFU=';
   ...
   $id = $arrayJson['events'][0]['source']['userId'];
    ...
    if($message == "hello"){
      ...
      switch ($message) {
        case "button":
          ...
          $action = array(
            ...
            New \LINE\LINEBot\TemplateActionBuilder\UriTemplateActionBuilder("Google", "https://www.google.co.th"),
      ...
      replyMsg($arrayHeader,$outputText);
    }
